...
class Fire(tf.keras.Model):
    def __init__(self, inplanes, squeeze_planes, expand1x1_planes, expand3x3_planes, name=None):
        ...
        self.squeeze = tf.keras.layers.Conv2D(squeeze_planes, input_shape=(
            inplanes,), kernel_size=1, strides=(1, 1), padding="VALID", activation='relu', name='squeeze')
        self.expand1x1 = tf.keras.layers.Conv2D(
            expand1x1_planes, kernel_size=1, padding="VALID", strides=(1, 1), activation='relu', name='e11')
        self.expand3x3 = tf.keras.layers.Conv2D(
            expand3x3_planes, kernel_size=3, padding="SAME", strides=(1, 1), activation='relu', name='e33')
    ...
    def __init__(self, num_classes=NUM_CLASSES):
        ...
        self.net = tf.keras.models.Sequential([
            tf.keras.layers.Conv2D(64, kernel_size=(3, 3),
                                   ...
                                   input_shape=(224, 224, 3), name='features/layer0'),
            ...
            tf.keras.layers.Conv2D(self.num_classes, kernel_size=1,
                                   padding="VALID",  activation='relu', name='classifier/layer1'),
